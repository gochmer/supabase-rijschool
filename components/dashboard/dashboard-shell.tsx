...
import { DashboardMenuButton } from "@/components/dashboard/dashboard-menu-button";
      ...
      >
        <aside
          className={cn(
            ...
            !isLearner &&
              (isStandardCompact ? "xl:sticky xl:top-4" : "xl:sticky xl:top-6"),
          )}
        >
          <div
            className={cn(
          ...
          >
            ...
            >
              ...
              >
                <Sparkles
                  className={cn(
                    "size-4",
                    isLearner ? "text-slate-200" : "text-primary",
                  )}
                />
              ...
              <p
                className={cn(
                  "mt-1 text-sm",
                  isLearner ? "text-slate-300" : "text-muted-foreground",
                )}
              >
                {today}
              </p>
            ...
            <div className="space-y-4">
              ...
              <div
                className={cn(
                  isLearner || isStandardCompact ? "grid gap-3" : "space-y-4",
                )}
              >
                <CommandPalette
                  role={role}
        ...
        <main
          className={cn(
            ...
            isStandardCompact
              ? "space-y-4"
              : "space-y-5 rounded-[1.65rem] p-2 sm:p-3",
            isLearner
        ...
        >
          <div
            className={cn(
              ...
              isStandardCompact
                ? "top-3 rounded-lg px-3 py-2"
                : "top-2 rounded-[1.25rem] px-4 py-3",
              isLearner
