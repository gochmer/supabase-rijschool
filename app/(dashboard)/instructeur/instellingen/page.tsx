...
>;
type InstructorDocumentSummary = InstructorSettingsOverview["documents"][number];
...
function findDocumentByKeywords(
...
function isDocumentReady(document?: InstructorDocumentSummary) {
  return Boolean(document?.hasUrl && document.status === "goedgekeurd");
}

function getAuthorityStatusLabel(
