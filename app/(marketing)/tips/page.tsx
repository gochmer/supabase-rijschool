              ...
              <div className="border-t border-slate-200 bg-slate-50/80 p-6 dark:border-white/10 dark:bg-white/[0.04] sm:p-8 xl:border-l xl:border-t-0">
                <div className="grid h-full content-center gap-4">
                  {[
                    ...
                    <div key={item.label} className="rounded-[1.6rem] border border-slate-200 bg-white/90 p-5 shadow-[0_20px_46px_-36px_rgba(15,23,42,0.18)] dark:border-white/10 dark:bg-white/6">
          ...
          {seoTipArticles.map((article) => (
            <Card key={article.slug} className="group rounded-[1.6rem] border border-white/80 bg-white/92 shadow-[0_24px_60px_-42px_rgba(15,23,42,0.18)] transition-all hover:-translate-y-1 hover:shadow-[0_30px_82px_-48px_rgba(15,23,42,0.32)] dark:border-white/10 dark:bg-[linear-gradient(145deg,rgba(15,23,42,0.88),rgba(30,41,59,0.82),rgba(15,23,42,0.9))] dark:shadow-[0_24px_60px_-42px_rgba(15,23,42,0.52)]">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex flex-wrap gap-2">{article.keywords.slice(0, 3).map((keyword) => <span key={keyword} className="rounded-full border border-slate-200 bg-white px-3 py-1 text-xs font-medium text-slate-600 dark:border-white/10 dark:bg-white/6 dark:text-slate-300">{keyword}</span>)}</div>
